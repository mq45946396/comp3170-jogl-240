 ...
 * Usage:
 * 
 * In the constructor create an InputManager and add it to both the JFrame and
 * the Canvas to listen for mouse events:
 * 
 * // set up Input manager this.input = new InputManager();
 * input.addListener(this); input.addListener(this.canvas);
 *
